...
const MenuItem: React.FC<{
  ...
  return !path ? (
    ...
    <Link className={classNames("no-underline")} to={path} onClick={onClick}>
      {inner}
    </Link>
  );
};
            ...
            {address && shownDarknodeList ? (
              shownDarknodeList
                .filter((darknodeID: string) => {
                  ...
                  return (
                    name.indexOf(searchFilter.toLowerCase()) !== -1 ||
                ...
                .map((darknodeID: string) => {
                  ...
                  return (
                    <SidebarIcon
                      ...
                      connected={
                        details && details.nodeStatistics ? true : false
                      }
                ...
                <div className="sidebar--row">
                  ...
                  <div className="sidebar--text">
                    <div className="sidebar--name">
                      Create new Darknode{" "}
                      <FontAwesomeIcon
                        icon={faExternalLinkAlt as FontAwesomeIconProps["icon"]}
