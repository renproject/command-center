...
export const Sidebar = () => {
    ...
    const { darknodeDetails, darknodeNames, quoteCurrency, darknodeList, hiddenDarknodes } = NetworkContainer.useContainer();
    ...
    const accountDarknodeList = useMemo(() => address ? darknodeList.get(address, null) : null, [darknodeList, address]);
    const accountHiddenDarknodes = useMemo(() => address ? hiddenDarknodes.get(address, null) : null, [hiddenDarknodes, address]);
    ...
    return <>
        <nav className={classNames("sidebar", address ? "sidebar--logged-in" : "", mobileMenuActive ? "sidebar--mobile--active" : "")}>
                    ...
                    {address && shownDarknodeList ? shownDarknodeList
                        ...
                        .map((darknodeID: string) => {
                            ...
                            return <SidebarIcon
                                ...
                                active={darknodeID === selectedDarknodeID}
