                ...
                return (
                    <div className="popup--buttons">
                        ...
                        <button
                            ...
                            disabled={
                                selectedAddress === null && !newAddressValid
                            }
                ...
                <div className="popup--top">
                    ...
                    <h2>
                        {stage === Stage.Withdrawing ? (
                            ...
                            <>
                                Enter your{" "}
                                {tokenDetails ? tokenDetails.name : token}{" "}
                                withdraw address
                            </>
                        )}
                    </h2>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    <FontAwesomeIcon
                                                        icon={
                                                            faCopy as FontAwesomeIconProps["icon"]
                                                        }
                                                        pull="right"
                                                    />
                                                </button>
                    ...
                    {stage === Stage.Done ? (
                        <div className="withdraw--loading">
                            <p>
                                {token} withdrawn. It will be deposited to your
                                address after 30 Ethereum confirmations.
                            </p>
                        </div>
                    ) : null}
                    {stage === Stage.DoneToken ? (
                    ...
                    {stage === Stage.Pending || stage === Stage.Error ? (
                        <form onSubmit={addNewAddress}>
                            ...
                            <p className="new-address--description">
                                This address is where you will receive your
                                rewards.
                            </p>
                        </form>
                    ) : null}
