 ...
 * Ethereum account
 */
export const LoggedOut: React.FC<Props> = ({
    newAddress,
    onCancel,
    onConnect,
}) => {
            ...
            {isDefined(newAddress) ? (
                <>
                    ...
                    <div className="popup--description">
                        Connect to continue as <Blocky address={newAddress} />{" "}
                        <span className="monospace">
                            {newAddress.substring(0, 8)}...
                            {newAddress.slice(-5)}
                        </span>
                        .
                    </div>
                ...
                <>
                    ...
                    <div className="popup--description">
                        Select an account to access your darknodes.
                    </div>
                </>
            )}
            <div className="popup--buttons">
                <button className="button button--white" onClick={onCancel}>
                    Not now
                </button>
                <button className="button button--blue" onClick={onConnect}>
                    Connect
                </button>
            </div>
        </Popup>
