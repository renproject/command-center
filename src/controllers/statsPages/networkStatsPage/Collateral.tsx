          ...
          <div className="collateral-status-outer">
            ...
            <div className="collateral-status">
              ...
              <span
                ...
                className={
                  loadingCollateralization ? "collateral-status--loading" : ""
                }
              >
                {GREYCORE_ACTIVE ? (
                  <>
                    ...
                    <InfoLabel direction={"bottom"}>
                      ...
                      and whilst they are in operation, RenVM does not need to
                      be over-collateralized to remain secure. Over time, once
                      the economics are safe, the Ren team will phase out the
                      Greycore.{" "}
            ...
            {!GREYCORE_ACTIVE ? (
              <div className="collateral-chart">
                <div className="collateral-chart--bar">
                  ...
                  >
                    <span className="collateral-chart--label">B</span>
                  </div>
                  {!overCollateralized ? (
                    <div
                      style={{ width: `${bDivL}%` }}
            ...
            >
              <div className="collateral-table--row">
                ...
                <div className="collateral-table--row--right">
                  ...
                  <InfoLabel>
                    The total value (TVL) of all digital assets currently locked
                    in RenVM.
                  </InfoLabel>
                </div>
              </div>
              <div className="collateral-table--row">
                ...
                <div className="collateral-table--row--right">
                  ...
                  <InfoLabel>
                    The value of digital assets currently being minted or burned
                    through RenVM. Equal to the value locked minus the value
                    minted.
                  </InfoLabel>
                </div>
              </div>
              ...
              <div className="collateral-table--row">
                ...
                <div className="collateral-table--row--right">
                  ...
                  <InfoLabel>
                    The collective value bonded by darknodes. Each node is
                    required to bond 100,000 REN.
                  </InfoLabel>
                </div>
              </div>
            </div>
