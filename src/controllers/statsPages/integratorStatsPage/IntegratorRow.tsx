      ...
      <tr className="integrator" onClick={toggleExpanded}>
        ...
        <td className="col-2">
          <div className="integrator-name">
            <span>{name}</span>
            <p>
              <ExternalLink href={urlHref} onClick={stopPropagation}>
                {url}
              </ExternalLink>
            </p>
          </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        {" - "}
                        <CurrencyIcon currency={quoteCurrency} />
                        {allVolumeBTC.toFormat()} {quoteCurrency.toUpperCase()}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        {" - "}
                        <CurrencyIcon currency={quoteCurrency} />
                        {allVolumeZEC.toFormat()} {quoteCurrency.toUpperCase()}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        {" - "}
                        <CurrencyIcon currency={quoteCurrency} />
                        {allVolumeBCH.toFormat()} {quoteCurrency.toUpperCase()}
                      </td>
                    </tr>
                  </tbody>
                </table>
