...
export const DarknodeView: React.FC<Props> = ({ darknodeDetails, darknodeID, name, isOperator, action, storeDarknodeName, publicKey }) => {
        ...
        <div className={`container darknodePage ${focusedClass} ${renamingCLass} ${noDarknodeClass}`}>
            ...
            <div className="darknodePage--bottom">
                ...
                <div className="block block--column">
                    ...
                    <EpochBlock timeUntilNextEpoch={timeUntilNextEpoch} timeSinceLastEpoch={timeSinceLastEpoch} minimumEpochInterval={minimumEpochInterval} />
                </div>
            </div>
        </div>
    );
