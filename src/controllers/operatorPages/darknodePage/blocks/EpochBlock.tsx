...
export const EpochBlock: React.FC<Props> = ({ timeUntilNextEpoch, timeSinceLastEpoch, minimumEpochInterval }) => (
    <Block className="epoch-block">
        ...
        <BlockBody>
            <EpochProgress timeSinceLastEpoch={timeSinceLastEpoch} timeUntilNextEpoch={timeUntilNextEpoch} minimumEpochInterval={minimumEpochInterval} />
        </BlockBody>
    </Block>
);
