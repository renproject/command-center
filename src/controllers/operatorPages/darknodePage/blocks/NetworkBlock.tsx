...
export const NetworkBlock: React.FC<Props> = ({ darknodeDetails }) => {
  const darknodeIDBase58 = darknodeDetails
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {darknodeDetails.nodeStatistics
                      ? darknodeDetails.nodeStatistics.multiAddress
                      : ""}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    {darknodeDetails.nodeStatistics
                      ? naturalTime(
                          Date.now() / SECONDS -
                            darknodeDetails.nodeStatistics.systemUptime,
                          {
                            message: "Just now",
                            countDown: false,
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {darknodeDetails.nodeStatistics
                      ? naturalTime(
                          Date.now() / SECONDS -
                            darknodeDetails.nodeStatistics.serviceUptime,
                          {
                            message: "Just now",
                            countDown: false,
                            showingSeconds: false,
                ...
                <tr>
                  ...
                  <td>
                    <CopyIcon />{" "}
                    {darknodeDetails.nodeStatistics
                      ? darknodeDetails.nodeStatistics.cores
                      : ""}
                  </td>
                </tr>
                <tr>
