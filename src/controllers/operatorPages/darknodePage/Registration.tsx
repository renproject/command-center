    ...
    <div className="status">
      ...
      {isOperator ? (
        <>
            ...
            !address ? (
              ...
              >
                {active ? (
                  <>
                    Registering{" "}
                    <Loading className="status--button--spinner" alt />
                  </>
                ) : (
          ...
          {registrationStatus === RegistrationStatus.Refundable ? (
            ...
            >
              {active ? (
                <>
                  Refunding <Loading className="status--button--spinner" alt />
                </>
              ) : (
                "Refund"
              )}
        ...
        <span className="status--operator">
          Operator:{" "}
          <span className="monospace">{darknodeDetails.operator}</span>
        </span>
      ) : null}
    </div>
  );
