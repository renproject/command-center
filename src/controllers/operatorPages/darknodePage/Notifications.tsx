...
export const Notifications: React.FC<Props> = ({
  ...
  const { timeUntilNextEpoch, timeSinceLastEpoch } = renVM || {
    timeUntilNextEpoch: null,
    timeSinceLastEpoch: null,
  };
  ...
  return (
    <div className="darknodePage--notifications">
      {notification ? (
        <div className={`darknodePage--notification ${notification.type}`}>
          <FontAwesomeIcon
            icon={
              notificationType[
                notification.type
