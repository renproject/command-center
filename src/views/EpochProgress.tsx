...
export const EpochProgress: React.FC<Props> = ({ timeSinceLastEpoch, timeUntilNextEpoch, minimumEpochInterval, small }) => {
    ...
    return (
        <div className={classNames("epoch--block--charts", small ? "epoch--block--charts--small" : null)}>
