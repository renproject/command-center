...
export const INFURA_KEY = (isDev() ? process.env.REACT_APP_DEV_INFURA_KEY : process.env.REACT_APP_INFURA_KEY) || process.env.REACT_APP_INFURA_KEY || "";
export const SENTRY_DSN = process.env.REACT_APP_SENTRY_DSN || "";
export const DEFAULT_REN_NETWORK = process.env.REACT_APP_NETWORK ? process.env.REACT_APP_NETWORK.toLowerCase() as RenNetwork : RenNetwork.Testnet;
...
export const MINIMUM_SHIFTED_AMOUNT = 0.0004;
