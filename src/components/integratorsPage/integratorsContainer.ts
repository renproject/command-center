...
import {
    Integrator, QUERY_BLOCK, QUERY_INTEGRATORS, QUERY_INTEGRATORS_HISTORY,
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            if (integrators.get(page) === undefined) {
                setIntegrators(currentIntegrators => currentIntegrators.set(page, null));
                ...
                setIntegrators(currentIntegrators => currentIntegrators.set(page, integratorsWithDay));
            }
        })().catch((error) => {
