...
const useGithubAPIContainer = () => {
    const [latestDarknodeVersionFull,
        setLatestDarknodeVersionFull] = useState(null as string | null);
    const [latestDarknodeVersion,
        setLatestDarknodeVersion] = useState(null as string | null);
    const [latestDarknodeVersionDaysAgo,
        setLatestDarknodeVersionDaysAgo] = useState(null as string | null);

    const [latestCLIVersionFull,
        setLatestCLIVersionFull] = useState(null as string | null);
    const [latestCLIVersion,
        setLatestCLIVersion] = useState(null as string | null);
    const [latestCLIVersionDaysAgo,
        setLatestCLIVersionDaysAgo] = useState(null as string | null);
    ...
    const updater = async () => {
        ...
        try {
            const response = await retryNTimes(() => Axios.get<VersionResponse | VersionError>(DARKNODE_ENDPOINT, {
        ...
        try {
            const response = await retryNTimes(() => Axios.get<VersionResponse | VersionError>(DARKNODE_CLI_ENDPOINT, {
                timeout: DEFAULT_REQUEST_TIMEOUT
            }
