...
const usePopupContainer = () => {
    ...
    const setPopup: (details: PopupDetails) => void = ({ popup: newPopup, overlay: newOverlay, dismissible: newDismissible, onCancel: newOnCancel }: PopupDetails) => {
    ...
    return {
        setPopup, clearPopup, popup, overlay, dismissible, onCancel,
    };
};
